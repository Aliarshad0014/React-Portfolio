                ...
                <div>
                    ...
                    <form className="lg:mt-16 mt-16 mx-auto max-w-5xl">
                        <div className="mb-6 h-24">
                            ...
                            <input type="text" id="name" name="name" className="border border-x-0 border-t-0 border-teal-500 appearance-none w-full py-2 text-gray-100 rounded-none leading-tight focus:outline-none focus:shadow-outline bgg" placeholder="Jhon Doe *" />
                        </div>

                        <div className="mb-6 h-24">
                            <label htmlFor="email" className="block text-gray-100 lg:text-lg text-sm font-bold mb-2">Whats Your Email?</label>
                            <input type="email" id="email" name="email" className="border border-x-0 border-t-0 border-teal-500 appearance-none bgg w-full py-2 rounded-none text-gray-100 leading-tight focus:outline-none focus:shadow-outline" placeholder="Jhon@doe.com *" />
                        </div>

                        <div className="mb-6">
                            <label htmlFor="message" className="block text-gray-100 lg:text-lg text-sm font-bold mb-2">Your Message</label>
                            <textarea id="message" name="message" rows="6" className="appearance-none border border-x-0 border-t-0 border-teal-500 bgg w-full py-2 text-gray-100 rounded-none leading-tight focus:outline-none focus:shadow-outline resize-none" placeholder="Hello Ali, Can you help me with...*"></textarea>
                        </div>
